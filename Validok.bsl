...
Функция ВалидацияЗначения(Значение, Шаблон, ИмяПоля = Неопределено)
	...
	Если ТипЗначенияТребуемый = Тип("Число") Тогда
		Стр = ВалидацияЗначенияТипаЧисло(Значение, Шаблон, ИмяПоля);
	ИначеЕсли ТипЗначенияТребуемый = Тип("Строка") Тогда
		Стр = ВалидацияЗначенияТипаСтрока(Значение, Шаблон, ИмяПоля);
	ИначеЕсли ТипЗначенияТребуемый = Тип("Массив") Тогда
		Стр = ВалидацияЗначенияТипаМассив(Значение, Шаблон);
	КонецЕсли;
...
Функция ВалидацияЗначенияТипаЧисло(Значение, Шаблон, ИмяПоля = Неопределено)
...
Функция ВалидацияЗначенияТипаСтрока(Значение, Шаблон, Знач ИмяПоля = Неопределено)
...
Функция ВалидацияЗначенияТипаМассив(Массив, Шаблон)
	...
	Для Индекс = 0 По Массив.ВГраница() Цикл
		...
		Стр = ВалидацияЗначения(Массив[Индекс], ШаблонЭлемента, Строка(Индекс));
