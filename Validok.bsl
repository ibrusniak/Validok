...
Функция Валидация(Значение, ШаблонJson) Экспорт
	...
	Стр = ВалидацияЗначения(Значение, Шаблон);
...
Функция ВалидацияЗначения(Значение, Шаблон, ИмяПоля = Неопределено, ИмяПоляВерхнегоУровня = Неопределено)
	...
	ИначеЕсли ТипЗначенияТребуемый = Тип("Массив") Тогда
		Стр = ВалидацияЗначенияТипаМассив(Значение, Шаблон, ИмяПоляВерхнегоУровня);
	КонецЕсли;
...
Функция ВалидацияЗначенияТипаЧисло(Значение, Шаблон, ИмяПоля = Неопределено, ИмяПоляВерхнегоУровня = Неопределено)
	
	СтруктураВозврата = СтруктураВозвратаВалидатора();

	ИмяПоля = ?(ИмяПоля = Неопределено, НСтр("en = 'Scalar'; ru = 'Скаляр'; uk = 'Скаляр'"), ИмяПоля);
...
Функция ВалидацияЗначенияТипаСтрока(Значение, Шаблон, Знач ИмяПоля = Неопределено, ИмяПоляВерхнегоУровня = Неопределено)
...
Функция ВалидацияЗначенияТипаМассив(Массив, Шаблон, ИмяПоляВерхнегоУровня = Неопределено)
