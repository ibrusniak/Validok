...
Функция Валидация(Знач Шаблон, Знач Данные, ИмяОбъектаВерхнегоУровня = "") Экспорт
	...
	СтруктураВозврата = Новый Структура("ВалидацияПройдена, ОшибкиВалидации", Истина, Новый Соответствие);
	...
	Для каждого ОписаниеПоля Из Шаблон Цикл
		...
		// Для данных типа Число проверим выход за границы диапазона, если диапазон задан
		...
		// Для данных составного типа (Соответствие) проверми сами данные по вложенному
		// шаблону, если он задан
...
Функция ЛокализованнаяСтрока(Ключ)
	...
	Структура.Вставить("ВалидацииЗначениеДолжноБытьБольше",
		НСтр("en = 'Value must be greater than %1'; ru = 'Значение должно быть больше %1'; uk = 'Значення має бути більшим за %1'"));
	
	Структура.Вставить("ВалидацииЗначениеДолжноБытьМеньше",
		НСтр("en = 'Value must be less than %1'; ru = 'Значение должно быть меньше %1'; uk = 'Значення має бути меншим за %1'"));
