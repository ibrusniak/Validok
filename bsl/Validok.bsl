...
Функция Валидация(Знач Шаблон, Знач Данные, ИмяОбъектаВерхнегоУровня = "") Экспорт
	...
	// Сперва проверим входные данные на наличе лишних полей
	...
	Для каждого ОписаниеПоля Из Шаблон Цикл
		...
		Если ТипЗначения = Тип("Соответствие") И ОписаниеПоля["Шаблон"] <> Неопределено Тогда
			...
			// Для "совтавных данных", то есть полей типа структура, в случае
			// когда задан также подшаблон - рекурсивно проверяем и сам
			// составной объект согласно этому подшаблону.
